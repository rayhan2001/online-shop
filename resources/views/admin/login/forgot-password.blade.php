                ...
                <div class="card shadow rounded-0 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-lg-6 d-flex align-items-center justify-content-center border-end">
                            <img src="{{asset('admin-asset')}}/images/error/forgot-password-frent-img.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6">
                                ...
                                <form class="form-body" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input type="email" name="email" class="form-control form-control-lg radius-30" id="inputEmailid" placeholder="Email id">
                                        </div>
                                        <div class="col-12">

            ...
            <div class="card radius-10 w-100">
                ...
                <div class="top-sellers-list p-2 mb-3">
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-1.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-2.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-3.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-4.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-5.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-6.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-7.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-8.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-9.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                            <h6 class="mb-0">David Buckley</h6>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('admin-asset')}}/images/avatars/avatar-10.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                            <h6 class="mb-0">Victoria Hardy</h6>

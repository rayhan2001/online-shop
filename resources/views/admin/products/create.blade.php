                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12 col-lg-4">
                                                    ...
                                                    <input type="text" name="sku" id="sku" class="form-control" placeholder="SKU (Stock Keeping Unit) ">
                                                ...
                                                <div class="col-12 col-lg-4">
                                                    ...
                                                    <input type="number" class="form-control" id="track_quantity" name="track_quantity" placeholder="Track Quantity">
